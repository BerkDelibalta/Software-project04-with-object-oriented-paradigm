...
public class TestR5 {
    ...
    public void testCountActivitiesPerWorker() throws TimesheetException {
        ...
        assertEquals(Integer.valueOf(4), activitiesPerWorker.get(secondWorkerID));
    }
    ...
    public void testGetRemainingHoursPerProject() throws TimesheetException {
        ...
        assertEquals(Integer.valueOf(6), remainingHoursPerProject.get("Development"));
